...
function parseContent(t, e = {
    ...
    }), new TextExtraction(t, n).parse().map(t => {
        t = t.children;
...
class Contact {
    ...
    lastUpdatedAt;
    constructor(t, e, n) {
        for (var [ i, r ] of Object.entries(t)) this.relays.push({
            url: i,
            read: r.read,
            write: r.write
        });
...
class Note extends BaseEvent {
    ...
    parseContent() {
        var t = parseContent(this.content);
        return this.parsedContent = t;
    }
}
